...
<nav class="bg-white border-gray-200 dark:bg-gray-900 sticky w-full z-40 top-0">
  ...
  <div class="flex md:order-1">
    ...
    <form method="get" action="/" class="relative hidden md:block">
      ...
      <input type="text" value="{{isset($_GET['search']) ? $_GET['search'] : ''}}" name="search" id="search-navbar" class="block w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Event ...">
    </form>
    ...
    <form action="/" value="{{isset($_GET['search']) ? $_GET['search'] : ''}}" method="get" class="items-center justify-between hidden w-full md:flex md:w-auto md:order-2" id="navbar-search">
...
<section class="bg-white grid place-items-center">
  <div class="py-5 px-4 h-full mx-auto max-w-screen-xl text-center z-10 relative">
        <a href="#" class="inline-flex justify-between items-center py-1 px-1 pe-4 mb-7 text-sm text-blue-700 bg-blue-100 rounded-full hover:bg-blue-200">
            <span class="text-xs bg-blue-600 rounded-full text-white px-4 py-1.5 me-3">New</span> <span class="text-sm font-medium">Buat Event-mu sendiri, Gratis!</span> 
            <svg class="w-2.5 h-2.5 ms-2 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
              <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 9 4-4-4-4"/>
            </svg>
        </a>
        <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl">Cari Konser Kesukaanmu!</h1>
        <p class="mb-8 text-sm font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48">Temukan berbagai Event, Konser dan Keseruan lainnya di seluruh Indonesia melalui Platform <strong class="text-nowrap">E-Ticketing</strong> dan Booking dengan <strong><em>Mudah, Cepat dan Aman.</em></strong></p>
        <form action="/" method="get" id="qrForm" class="w-full max-w-md mx-auto">   
            <label for="default-email" class="mb-2 text-sm font-medium text-gray-900 sr-only">search</label>
            <div class="relative">
                ...
                <input type="text" name="search" id="textInput" placeholder="Cari Event, Konser, Artis dll..." required class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-white focus:ring-blue-500 focus:border-blue-500" />
  ...
  <div class="flex w-full px-4 items-center">
    ...
    <div class="px-4 text-gray-500 font-bold">Event Terpopuler</div>
    <div class="flex-1 border-b-2"></div>
  </div>
...
<footer class="p-4 bg-gray-100/50 md:p-8 lg:p-10 dark:bg-gray-800 mt-10">
